...
#### SUPPLEMENTARY EXPERIMENT 3 (UNCERTAINTY TRACKING) ####
#### SE3 Load and prep datasets #### 
setwd(wd)
dat_unc_tr_ctrl <- read.csv("data_supplementary_experiment_3.csv")
...
#### SE3 Load data from the main study #### 
...
dat <- read.csv(sprintf("data_main_experiment_children_%s.csv", data_batch))
...
#### SE3 Controlling for average uncertainty tracking in the main experiment ####
