...
#### EXPERIMENT 4 (COGNITIVE UTILITY CONTROL) ####
#### Load and prep datasets #### 
setwd(wd)
dat_cog_ctrl <- read.csv("data_experiment_4.csv")
...
child_test_fixed_uncertainty_omega <- get_omega(child_test_fixed_uncertainty$Chisq[2], as.integer(ngrps(child_cog_ctrl_mod_full_int)))
